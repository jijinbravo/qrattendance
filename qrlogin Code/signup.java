...
public class signup extends AppCompatActivity {
    ...
    /* renamed from: com.example.jijin.qrlogin.signup$1 */
    public class C01681 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ signup this$0;
        public final /* synthetic */ DatabaseReference val$table_user;

        /* renamed from: com.example.jijin.qrlogin.signup$1$1 */
        public class C01671 implements ValueEventListener {
            public static volatile transient /* synthetic */ IncrementalChange $change;
            public static final long serialVersionUID = 0;
            public final /* synthetic */ C01681 this$1;
            public final /* synthetic */ ProgressDialog val$mDialog;

            C01671(Object[] objArr, InstantReloadException instantReloadException) {
                switch (((String) objArr[1]).hashCode()) {
                    case -1968665286:
                        return;
                    case -110999793:
                        this((C01681) objArr[2], (ProgressDialog) objArr[3]);
                        return;
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/signup$1$1"}));
                }
            }

            public static /* synthetic */ Object access$super(C01671 c01671, String str, Object... objArr) {
                switch (str.hashCode()) {
                    case -2128160755:
                    ...
                    case 2025021518:
                        return super.clone();
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/signup$1$1"}));
                }
            }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(this.this$1.this$0.etusername.getText().toString()).exists()) {
                    this.val$mDialog.dismiss();
                    Toast.makeText(this.this$1.this$0, "already registered", 0).show();
                } else {
                    this.val$mDialog.dismiss();
                    this.this$1.val$table_user.child(this.this$1.this$0.etusername.getText().toString()).setValue(new User(this.this$1.this$0.etname.getText().toString(), this.this$1.this$0.etpassword.getText().toString()));
                    Toast.makeText(this.this$1.this$0, "sigup successfull", 0).show();
                }
                this.this$1.this$0.finish();
            }

            public C01671(C01681 this$1, ProgressDialog progressDialog) {
                IncrementalChange incrementalChange = $change;
                this.this$1 = this$1;
                this.val$mDialog = progressDialog;
                if (incrementalChange != null) {
                    Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/signup$1$1;Lcom/example/jijin/qrlogin/signup$1;Landroid/app/ProgressDialog;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$1, progressDialog, new Object[0]});
                    Object[] objArr2 = (Object[]) objArr[0];
                    this(objArr, null);
                    objArr2[0] = this;
                    incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/signup$1$1;Lcom/example/jijin/qrlogin/signup$1;Landroid/app/ProgressDialog;[Ljava/lang/Object;)V", objArr2);
                }
            }
        }

        C01681(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case -1945824458:
                    this((signup) objArr[2], (DatabaseReference) objArr[3]);
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/signup$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C01681 c01681, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1554832987:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/signup$1"}));
            }
        }
        ...
        public void onClick(View v) {
            ...
            } else if (signup.access$000(this.this$0).booleanValue()) {
                ProgressDialog mDialog = new ProgressDialog(this.this$0);
                mDialog.setMessage("please wait....");
                mDialog.show();
                this.val$table_user.addValueEventListener(new C01671(this, mDialog));
            }
        }

        public C01681(signup this$0, DatabaseReference databaseReference) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            this.val$table_user = databaseReference;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/signup$1;Lcom/example/jijin/qrlogin/signup;Lcom/google/firebase/database/DatabaseReference;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, databaseReference, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/signup$1;Lcom/example/jijin/qrlogin/signup;Lcom/google/firebase/database/DatabaseReference;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    signup(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            case -2089128195:
                return;
            case -1881912584:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/signup"}));
        }
    }

    public static /* synthetic */ Boolean access$000(signup x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange == null) {
            return x0.validate();
        }
        return (Boolean) incrementalChange.access$dispatch("access$000.(Lcom/example/jijin/qrlogin/signup;)Ljava/lang/Boolean;", new Object[]{x0});
    }

    public static /* synthetic */ Object access$super(signup signup, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/signup"}));
        }
    }
    ...
    private Boolean validate() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return (Boolean) incrementalChange.access$dispatch("validate.()Ljava/lang/Boolean;", new Object[]{this});
        }
        Boolean result = Boolean.valueOf(false);
        String name = this.etusername.getText().toString();
        String password = this.etpassword.getText().toString();
        String email = this.etname.getText().toString();
        if (name.isEmpty() || password.isEmpty() || email.isEmpty()) {
            Toast.makeText(this, "Enter all the details", 0).show();
        } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0161R.layout.activity_signup);
        this.etusername = (EditText) findViewById(C0161R.id.etusername);
        this.etname = (EditText) findViewById(C0161R.id.etname);
        this.etpassword = (EditText) findViewById(C0161R.id.etpassword);
        this.btnsignup = (Button) findViewById(C0161R.id.btnsignup);
        this.btnsignup.setOnClickListener(new C01681(this, FirebaseDatabase.getInstance().getReference("att")));
    }

    public signup() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/signup;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/signup;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
