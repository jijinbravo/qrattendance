...
public class MainActivity extends AppCompatActivity {
    ...
    /* renamed from: com.example.jijin.qrlogin.MainActivity$1 */
    public class C01581 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ MainActivity this$0;

        C01581(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case -1856481053:
                    this((MainActivity) objArr[2]);
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/MainActivity$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C01581 c01581, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/MainActivity$1"}));
            }
        }
        ...
        public void onClick(View v) {
            ...
            this.this$0.startActivity(new Intent(this.this$0, signup.class));
        }

        public C01581(MainActivity this$0) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/MainActivity$1;Lcom/example/jijin/qrlogin/MainActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/MainActivity$1;Lcom/example/jijin/qrlogin/MainActivity;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    /* renamed from: com.example.jijin.qrlogin.MainActivity$2 */
    public class C01602 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ MainActivity this$0;
        public final /* synthetic */ DatabaseReference val$table_user;

        /* renamed from: com.example.jijin.qrlogin.MainActivity$2$1 */
        public class C01591 implements ValueEventListener {
            public static volatile transient /* synthetic */ IncrementalChange $change;
            public static final long serialVersionUID = 0;
            public final /* synthetic */ C01602 this$1;
            public final /* synthetic */ ProgressDialog val$mDialog;

            C01591(Object[] objArr, InstantReloadException instantReloadException) {
                switch (((String) objArr[1]).hashCode()) {
                    case -1968665286:
                        return;
                    case -1213257553:
                        this((C01602) objArr[2], (ProgressDialog) objArr[3]);
                        return;
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/MainActivity$2$1"}));
                }
            }

            public static /* synthetic */ Object access$super(C01591 c01591, String str, Object... objArr) {
                switch (str.hashCode()) {
                    case -2128160755:
                        return super.toString();
                    case -1554832987:
                    ...
                    case 2025021518:
                        return super.clone();
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/MainActivity$2$1"}));
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                IncrementalChange incrementalChange = $change;
                if (incrementalChange != null) {
                    incrementalChange.access$dispatch("onCancelled.(Lcom/google/firebase/database/DatabaseError;)V", new Object[]{this, databaseError});
                }
            }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                IncrementalChange incrementalChange = $change;
                if (incrementalChange != null) {
                    incrementalChange.access$dispatch("onDataChange.(Lcom/google/firebase/database/DataSnapshot;)V", new Object[]{this, dataSnapshot});
                } else if (dataSnapshot.child(this.this$1.this$0.etusername.getText().toString()).exists()) {
                    this.val$mDialog.dismiss();
                    if (((User) dataSnapshot.child(this.this$1.this$0.etusername.getText().toString()).getValue(User.class)).getPassword().equals(this.this$1.this$0.etpassword.getText().toString())) {
                        Toast.makeText(this.this$1.this$0, "sign is successfully..", 0).show();
                        this.this$1.this$0.startActivity(new Intent(this.this$1.this$0, scan.class));
                        return;
                    }
                    Toast.makeText(this.this$1.this$0, "sign is failed..", 0).show();
                    MainActivity.access$010(this.this$1.this$0);
                    this.this$1.this$0.info.setText("no of attempts remaining:" + String.valueOf(MainActivity.access$000(this.this$1.this$0)));
                    if (MainActivity.access$000(this.this$1.this$0) == 0) {
                        this.this$1.this$0.btnsignin.setEnabled(false);
                    }
                } else {
                    this.val$mDialog.dismiss();
                    Toast.makeText(this.this$1.this$0, "user not exist in database..", 0).show();
                }
            }

            public C01591(C01602 this$1, ProgressDialog progressDialog) {
                IncrementalChange incrementalChange = $change;
                this.this$1 = this$1;
                this.val$mDialog = progressDialog;
                if (incrementalChange != null) {
                    Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/MainActivity$2$1;Lcom/example/jijin/qrlogin/MainActivity$2;Landroid/app/ProgressDialog;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$1, progressDialog, new Object[0]});
                    Object[] objArr2 = (Object[]) objArr[0];
                    this(objArr, null);
                    objArr2[0] = this;
                    incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/MainActivity$2$1;Lcom/example/jijin/qrlogin/MainActivity$2;Landroid/app/ProgressDialog;[Ljava/lang/Object;)V", objArr2);
                }
            }
        }

        C01602(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case -869237577:
                    this((MainActivity) objArr[2], (DatabaseReference) objArr[3]);
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/MainActivity$2"}));
            }
        }

        public static /* synthetic */ Object access$super(C01602 c01602, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1554832987:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/MainActivity$2"}));
            }
        }
        ...
        public void onClick(View v) {
            ...
            ProgressDialog mDialog = new ProgressDialog(this.this$0);
            mDialog.setMessage("please wait....");
            mDialog.show();
            this.val$table_user.addValueEventListener(new C01591(this, mDialog));
        }

        public C01602(MainActivity this$0, DatabaseReference databaseReference) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            this.val$table_user = databaseReference;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/MainActivity$2;Lcom/example/jijin/qrlogin/MainActivity;Lcom/google/firebase/database/DatabaseReference;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, databaseReference, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/MainActivity$2;Lcom/example/jijin/qrlogin/MainActivity;Lcom/google/firebase/database/DatabaseReference;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }
    ...
    MainActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            ...
            case -260332760:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/MainActivity"}));
        }
    }

    public static /* synthetic */ int access$000(MainActivity x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange == null) {
            return x0.counter;
        }
        return ((Number) incrementalChange.access$dispatch("access$000.(Lcom/example/jijin/qrlogin/MainActivity;)I", new Object[]{x0})).intValue();
    }

    public static /* synthetic */ int access$010(MainActivity x0) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Number) incrementalChange.access$dispatch("access$010.(Lcom/example/jijin/qrlogin/MainActivity;)I", new Object[]{x0})).intValue();
        }
        int i = x0.counter;
        x0.counter = i - 1;
        return i;
    ...
    public static /* synthetic */ Object access$super(MainActivity mainActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/MainActivity"}));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.btnsignin = (Button) findViewById(C0161R.id.btnsignin);
        this.btnsignup = (Button) findViewById(C0161R.id.btnsignup);
        this.etusername = (EditText) findViewById(C0161R.id.etusername);
        this.etpassword = (EditText) findViewById(C0161R.id.etpassword);
        this.info = (TextView) findViewById(C0161R.id.tvinfo);
        this.info.setText("no of attempts remaining:5");
        DatabaseReference table_user = FirebaseDatabase.getInstance().getReference("att");
        this.btnsignup.setOnClickListener(new C01581(this));
        this.btnsignin.setOnClickListener(new C01602(this, table_user));
    }

    public MainActivity() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/MainActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/MainActivity;[Ljava/lang/Object;)V", objArr2);
            return;
        }
        this.counter = 5;
    }
