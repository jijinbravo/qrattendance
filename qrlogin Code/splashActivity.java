...
public class splashActivity extends AppCompatActivity {
    ...
    /* renamed from: com.example.jijin.qrlogin.splashActivity$1 */
    public class C01691 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ splashActivity this$0;

        C01691(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case 716501795:
                    this((splashActivity) objArr[2]);
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/splashActivity$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C01691 c01691, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/splashActivity$1"}));
            }
        }
        ...
        public C01691(splashActivity this$0) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/splashActivity$1;Lcom/example/jijin/qrlogin/splashActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/splashActivity$1;Lcom/example/jijin/qrlogin/splashActivity;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    splashActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            case -2089128195:
                return;
            case -1859998602:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/splashActivity"}));
        }
    }

    public static /* synthetic */ Object access$super(splashActivity splashactivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/splashActivity"}));
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(C0161R.id.button2)).setOnClickListener(new C01691(this));
    }

    public splashActivity() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/splashActivity;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/splashActivity;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
