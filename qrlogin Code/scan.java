...
public class scan extends AppCompatActivity {
    ...
    /* renamed from: com.example.jijin.qrlogin.scan$1 */
    public class C01621 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ scan this$0;

        C01621(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                ...
                case -913799933:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan$1"}));
            }
        }

        public static /* synthetic */ Object access$super(C01621 c01621, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan$1"}));
            }
        }
        ...
        public void onClick(View v) {
            ...
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onClick.(Landroid/view/View;)V", new Object[]{this, v});
                return;
            }
            this.this$0.startActivity(new Intent(this.this$0, MainActivity.class));
        }

        public C01621(scan this$0) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan$1;Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan$1;Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    /* renamed from: com.example.jijin.qrlogin.scan$2 */
    public class C01632 implements OnClickListener {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ scan this$0;
        ...
        C01632(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case 1789375776:
                    this((scan) objArr[2], (Activity) objArr[3], (String) objArr[4]);
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan$2"}));
            }
        }

        public static /* synthetic */ Object access$super(C01632 c01632, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1554832987:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan$2"}));
            }
        }
        ...
        public void onClick(View view) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onClick.(Landroid/view/View;)V", new Object[]{this, view});
                return;
            }
            IntentIntegrator integrator = new IntentIntegrator(this.val$activity);
            ...
            this.this$0.s1 = this.this$0.e1.getText().toString();
            this.this$0.s2 = this.val$currentDate.toString();
        }

        public C01632(scan this$0, Activity activity, String str) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            this.val$activity = activity;
            this.val$currentDate = str;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan$2;Lcom/example/jijin/qrlogin/scan;Landroid/app/Activity;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, activity, str, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan$2;Lcom/example/jijin/qrlogin/scan;Landroid/app/Activity;Ljava/lang/String;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    /* renamed from: com.example.jijin.qrlogin.scan$3 */
    public class C01663 implements Callback {
        public static volatile transient /* synthetic */ IncrementalChange $change;
        public static final long serialVersionUID = 0;
        public final /* synthetic */ scan this$0;

        /* renamed from: com.example.jijin.qrlogin.scan$3$1 */
        public class C01641 implements Runnable {
            public static volatile transient /* synthetic */ IncrementalChange $change;
            public static final long serialVersionUID = 0;
            public final /* synthetic */ C01663 this$1;

            C01641(Object[] objArr, InstantReloadException instantReloadException) {
                switch (((String) objArr[1]).hashCode()) {
                    case -1968665286:
                        return;
                    case 602774371:
                        this((C01663) objArr[2]);
                        return;
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan$3$1"}));
                }
            }

            public static /* synthetic */ Object access$super(C01641 c01641, String str, Object... objArr) {
                switch (str.hashCode()) {
                    case -2128160755:
                        return super.toString();
                    case -1554832987:
                    ...
                    case 2025021518:
                        return super.clone();
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan$3$1"}));
                }
            }
            ...
            public void run() {
                IncrementalChange incrementalChange = $change;
                if (incrementalChange != null) {
                    incrementalChange.access$dispatch("run.()V", new Object[]{this});
                }
            }

            public C01641(C01663 this$1) {
                IncrementalChange incrementalChange = $change;
                this.this$1 = this$1;
                if (incrementalChange != null) {
                    Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan$3$1;Lcom/example/jijin/qrlogin/scan$3;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$1, new Object[0]});
                    Object[] objArr2 = (Object[]) objArr[0];
                    this(objArr, null);
                    objArr2[0] = this;
                    incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan$3$1;Lcom/example/jijin/qrlogin/scan$3;[Ljava/lang/Object;)V", objArr2);
                }
            }
        }

        /* renamed from: com.example.jijin.qrlogin.scan$3$2 */
        public class C01652 implements Runnable {
            public static volatile transient /* synthetic */ IncrementalChange $change;
            public static final long serialVersionUID = 0;
            public final /* synthetic */ C01663 this$1;
            public final /* synthetic */ Response val$response;

            C01652(Object[] objArr, InstantReloadException instantReloadException) {
                switch (((String) objArr[1]).hashCode()) {
                    case -1968665286:
                        return;
                    case -421441838:
                        this((C01663) objArr[2], (Response) objArr[3]);
                        return;
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan$3$2"}));
                }
            }

            public static /* synthetic */ Object access$super(C01652 c01652, String str, Object... objArr) {
                switch (str.hashCode()) {
                    case -2128160755:
                        return super.toString();
                    case -1554832987:
                    ...
                    case 2025021518:
                        return super.clone();
                    default:
                        throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan$3$2"}));
                }
            }
            ...
            public void run() {
                ...
                try {
                    Toast.makeText(this.this$1.this$0.getApplicationContext(), this.val$response.body().string(), 0).show();
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }

            public C01652(C01663 this$1, Response response) {
                IncrementalChange incrementalChange = $change;
                this.this$1 = this$1;
                this.val$response = response;
                if (incrementalChange != null) {
                    Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan$3$2;Lcom/example/jijin/qrlogin/scan$3;Lokhttp3/Response;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$1, response, new Object[0]});
                    Object[] objArr2 = (Object[]) objArr[0];
                    this(objArr, null);
                    objArr2[0] = this;
                    incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan$3$2;Lcom/example/jijin/qrlogin/scan$3;Lokhttp3/Response;[Ljava/lang/Object;)V", objArr2);
                }
            }
        }

        C01663(Object[] objArr, InstantReloadException instantReloadException) {
            switch (((String) objArr[1]).hashCode()) {
                case -1968665286:
                    return;
                case -254268411:
                    ...
                    return;
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan$3"}));
            }
        }

        public static /* synthetic */ Object access$super(C01663 c01663, String str, Object... objArr) {
            switch (str.hashCode()) {
                case -2128160755:
                    return super.toString();
                case -1554832987:
                ...
                case 2025021518:
                    return super.clone();
                default:
                    throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan$3"}));
            }
        }
        ...
        public void onFailure(Call call, IOException e) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onFailure.(Lokhttp3/Call;Ljava/io/IOException;)V", new Object[]{this, call, e});
                return;
            }
            this.this$0.runOnUiThread(new C01641(this));
        }

        public void onResponse(Call call, Response response) {
            IncrementalChange incrementalChange = $change;
            if (incrementalChange != null) {
                incrementalChange.access$dispatch("onResponse.(Lokhttp3/Call;Lokhttp3/Response;)V", new Object[]{this, call, response});
                return;
            }
            this.this$0.runOnUiThread(new C01652(this, response));
        }

        public C01663(scan this$0) {
            IncrementalChange incrementalChange = $change;
            this.this$0 = this$0;
            if (incrementalChange != null) {
                Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan$3;Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, this$0, new Object[0]});
                Object[] objArr2 = (Object[]) objArr[0];
                this(objArr, null);
                objArr2[0] = this;
                incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan$3;Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)V", objArr2);
            }
        }
    }

    scan(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[1]).hashCode()) {
            case -2089128195:
                return;
            case -986978275:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[1], Integer.valueOf(((String) objArr[1]).hashCode()), "com/example/jijin/qrlogin/scan"}));
        }
    }

    public static /* synthetic */ Object access$super(scan scan, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2147180915:
            ...
            case -1158180317:
                return super.onWindowStartingSupportActionMode((android.support.v7.view.ActionMode.Callback) objArr[0]);
            case -1145345097:
            ...
            case 743397380:
                ...
                return null;
            case 746849712:
                return super.startSupportActionMode((android.support.v7.view.ActionMode.Callback) objArr[0]);
            case 757106516:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/example/jijin/qrlogin/scan"}));
        }
    }

    private void sendPost(String id, String date) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("sendPost.(Ljava/lang/String;Ljava/lang/String;)V", new Object[]{this, id, date});
            return;
        }
        String url = "https://data.aridity59.hasura-app.io/v1/query";
        try {
            new OkHttpClient().newCall(new Builder().url(url).post(RequestBody.create(MediaType.parse("application/json"), new JSONObject().put("type", "insert").put("args", new JSONObject().put("table", "dailyattendance").put("objects", new JSONArray().put(new JSONObject().put("id", id).put("date", date).put(NotificationCompat.CATEGORY_STATUS, "PRESENT").put("class", "cse3b")))).toString())).build()).enqueue(new C01663(this));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("onActivityResult.(IILandroid/content/Intent;)V", new Object[]{this, new Integer(requestCode), new Integer(resultCode), data});
            return;
        }
        ...
        } else if (result.getContents().equals("hi")) {
            sendPost(this.s1, this.s2);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0161R.layout.activity_scan);
        this.e1 = (EditText) findViewById(C0161R.id.etid);
        this.e2 = (EditText) findViewById(C0161R.id.etusername);
        this.e3 = (EditText) findViewById(C0161R.id.etname);
        this.e4 = (EditText) findViewById(C0161R.id.etcls);
        String currentDate = DateFormat.getDateInstance().format(Calendar.getInstance().getTime());
        ((EditText) findViewById(C0161R.id.etusername)).setText(currentDate);
        this.button = (Button) findViewById(C0161R.id.bloc);
        this.scan_Btn = (Button) findViewById(C0161R.id.scab_btn);
        this.button.setOnClickListener(new C01621(this));
        this.scan_Btn.setOnClickListener(new C01632(this, this, currentDate));
    }

    public scan() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            Object[] objArr = (Object[]) incrementalChange.access$dispatch("init$args.([Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)Ljava/lang/Object;", new Object[]{null, new Object[0]});
            Object[] objArr2 = (Object[]) objArr[0];
            this(objArr, null);
            objArr2[0] = this;
            incrementalChange.access$dispatch("init$body.(Lcom/example/jijin/qrlogin/scan;[Ljava/lang/Object;)V", objArr2);
        }
    }
}
